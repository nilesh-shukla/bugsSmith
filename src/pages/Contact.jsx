  ...
  return (
    <div className='pt-[20vh] px-15 flex flex-col gap-y-20 outfit-font'>
        <div className='flex justify-between'>
            ...
            {/* Form */}
            <div className='p-6 flex flex-col gap-4 text-[#86acb1] w-2xl rounded-2xl bg-[#153955]'>
                <div className='grid grid-rows-2 grid-cols-2 gap-x-2 gap-y-4'>
                ...
                <button className='bg-white p-4 rounded-full w-fit font-semibold text-[#052553]'>Submit</button>
