...
function Features({ icon, title, numbers, changingRate, iconBgColor, rateColor}) {
  return (
    <div className="flex relative justify-between gap-2 rounded-2xl bg-[#accae9] p-2 items-center">
        <div className="flex gap-4 items-center">
            ...
            <div>
                <h1 className="text-sm text-[#2a4aea]" style={{fontWeight: 400}}>{title}</h1>
                <h1 className="text-4xl text-white font-semibold">{numbers}</h1>
            </div>
        </div>
        <div>
