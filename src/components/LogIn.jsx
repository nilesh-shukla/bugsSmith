...
function LogIn({ asModal = false, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try{
        ...
        //Now using Context API for better state management and adding auto-login feature upon refreshing the page
        login(data.token, data.user);
        navigate('/analyze');

        //We do not use this part as we are handling JWT expiry/invalidity in central apiFetch function
        // if(!response.ok){
        //     setError(data.error || 'Login failed');
        //     return;
        // }

        //Used to store token and user info generated by JWT Logic like this:-
