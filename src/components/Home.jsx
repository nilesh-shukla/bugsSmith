        ...
        <div className='outfit-font'>
          ...
          <div className='flex flex-col gap-10 lg:gap-20'>
            ...
            <div className='grid grid-rows-[auto_auto] xl:grid-cols-2 gap-10'>
              ...
              {/* Right */}
              <div className='border-2 aspect-square border-[#1e3a4f] bg-cover bg-center bg-no-repeat opacity-40 relative group rounded-xl cursor-pointer' style={{backgroundImage: `url(${chipSetImg})`}}>
                <label 
